% =========================================================================
%  IQC-BASED ROA BENCHMARK  (comparison baseline, Table I)
%
%  Adapted from the public integral quadratic constraint (IQC) approach of
%      H. Yin, P. Seiler, M. Arcak, "Stability analysis using quadratic
%      constraints for systems with neural network controllers,"
%      IEEE TAC, 67(4):1980-1987, 2021.        (reference [4] in the paper)
%
%  STATUS: reference implementation, NOT self-contained. To run it you need:
%    * CVX                          ( http://cvxr.com/cvx )  and an SDP solver
%    * the helper functions  mycolor, nnclosedloop, garyfyFigure
%      (from Yin et al.'s IQC-NN code base -- not included here)
%    * the NN weights under  Wb_s32_tanh/  (W1final.csv, W2final.csv, ...)
%
%  It is provided only to document how the Table I / Fig. 6b IQC numbers were
%  obtained. The headline methods of this repository (local sector bound and
%  Lyapunov LMI) live in ../examples and are fully self-contained.
% =========================================================================
