...
| Local sector bound — Theorem 4 | Region-of-attraction estimates |
|:---:|:---:|
| <img src="docs/figures/fig5_local_sector_bounds.png" width="370"> | <img src="docs/figures/fig6b_roa_comparison.png" width="370"> |
| <sub>Tight sector `[γ1, γ2]` for the FFNN as the input range grows, from layer-wise propagation (Fig. 5).</sub> | <sub>Linear positive-Aizerman, Lyapunov, and IQC ROA estimates compared on the example (Fig. 6b).</sub> |
